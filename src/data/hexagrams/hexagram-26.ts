export const hexagram26 = {
  ...
  lines: [
    ...
    "A good horse that follows others. Awareness of danger, with perseverance, furthers. Practice chariot driving and armed defense daily. It furthers one to have somewhere to go. You are a good horse—you follow others. But you are aware of danger. With perseverance, this furthers. Practice daily. Prepare. When the time comes, you will be ready. It furthers one to have somewhere to go—know your direction.",
    "The headboard of a young bull. Great good fortune. The headboard is on the young bull—the restraint is in place. This brings great good fortune because the bull is being tamed while it is still young. The power is being held before it becomes destructive. This is the wisdom of early restraint.",
    "The tusk of a gelded boar. Good fortune. The tusk of a gelded boar—the power is there, but it is tempered. This brings good fortune. The boar is still strong, but it is no longer dangerous. This is the taming of the great: not the destruction of power, but the tempering of it.",
    "One attains the way of heaven. Success. At the peak, you attain the way of heaven. The taming is complete. The power is held, tempered, ready. Success follows. You have learned to hold great power without being destroyed by it. This is the achievement of the great."
  ],
  trigrams: {
    lower: {
      name: "Qián (Heaven)",
